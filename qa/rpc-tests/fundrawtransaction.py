...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid godlikeproducts address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid godlikeproducts address" in e.error['message'])
