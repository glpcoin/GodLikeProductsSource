    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("GLP-light"), QVariant("light"));
    ui->theme->addItem(QString("GLP-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("GLP-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("GLP-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("GLP-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("GLP-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("GLP-traditional"), QVariant("trad"));
