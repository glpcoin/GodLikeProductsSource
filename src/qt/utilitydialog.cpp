    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  godlikeproducts-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the GodLikeProducts in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 GLP, 0.1 GLP, 1 GLP and 10 GLP -- sort of like the paper money you use every day.</li> \
