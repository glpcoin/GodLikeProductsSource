...
2. run godlikeproductsd with -printalert or -sendalert like this:
   /path/to/godlikeproductsd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.godlikeproducts.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/GodLikeProducts Core:0.12.0.58/"));
