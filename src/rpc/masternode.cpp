...
UniValue masternode(const JSONRPCRequest& request)
{
    ...
    if (strCommand == "outputs") {
        ...
        pwalletMain->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_2100);
...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print GodLikeProducts address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "godlikeproducts",               "masternode",             &masternode,             true,  {} },
    { "godlikeproducts",               "masternodelist",         &masternodelist,         true,  {} },
    { "godlikeproducts",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "godlikeproducts",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "godlikeproducts",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "godlikeproducts",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
