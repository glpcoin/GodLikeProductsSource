...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in godlikeproducts.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("godlikeproducts.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "godlikeproducts",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "godlikeproducts",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "godlikeproducts",               "gobject",                &gobject,                true,  {} },
    { "godlikeproducts",               "voteraw",                &voteraw,                true,  {} },
