...
This mechanism has been integrated into Bitcore-Node-GodLikeProducts which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/godlikeproductspay/insight-api-godlikeproducts#web-socket-api](https://github.com/godlikeproductspay/insight-api-godlikeproducts#web-socket-api)
* API: [https://github.com/godlikeproductspay/insight-api-godlikeproducts#instantsend-transactions](https://github.com/godlikeproductspay/insight-api-godlikeproducts#instantsend-transactions)
...
By default, the GodLikeProducts Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GodLikeProducts Core daemon:
