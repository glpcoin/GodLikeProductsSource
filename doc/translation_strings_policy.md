...
This document provides guidelines for internationalization of the GodLikeProducts Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `godlikeproducts_en.ts` remains unchanged.
